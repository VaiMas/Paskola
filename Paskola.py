    ...
    def mokejimo_grafikas(self):
        ...
        with open(f'Paskola.csv', 'a', newline='') as file:
            ...
            for menuo in range(1, self.terminas + 1):
                ...
                # writer.writerow([menuo, round(imokos_dydis, 2), round(likutis, 2), round(menesio_palukanos, 2),
                #                   round(moketina_suma, 2)])
            ...
            writer.writerow(['Bendra suma', self.suma, '',round(sumoketos_palukanos, 2), round(sumoketa_suma, 2)])
